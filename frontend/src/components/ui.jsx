...
export function Disclaimer({ children }) {
  return (
    <div className="rounded-sm border border-amber/30 bg-amber/5 px-4 py-3 text-xs leading-relaxed text-ink/80">
      <span className="font-semibold text-amber">Demo project — not medical advice.</span>{' '}
      {children || 'MedVerse AI is a portfolio demonstration. Always consult a licensed healthcare professional for real medical decisions.'}
    </div>
  )
}
